    ...
    alter table ss_resource_authority 
        drop constraint FKD72168911C7ADE4;

    alter table ss_resource_authority 
        drop constraint FKD7216891E6621EB0;

    alter table ss_role_authority 
        drop constraint FKE536BA79CF8030B0;

    alter table ss_role_authority 
        drop constraint FKE536BA791C7ADE4;

    alter table ss_user_role 
        drop constraint FK1306854BCF8030B0;

    alter table ss_user_role 
        drop constraint FK1306854B74AAF490;
    ...
    alter table ss_resource_authority 
        add constraint FKD72168911C7ADE4 
        foreign key (authority_id) 
        references ss_authority;

    alter table ss_resource_authority 
        add constraint FKD7216891E6621EB0 
        foreign key (resource_id) 
        references ss_resource;

    alter table ss_role_authority 
        add constraint FKE536BA79CF8030B0 
        foreign key (role_id) 
        references ss_role;

    alter table ss_role_authority 
        add constraint FKE536BA791C7ADE4 
        foreign key (authority_id) 
        references ss_authority;

    alter table ss_user_role 
        add constraint FK1306854BCF8030B0 
        foreign key (role_id) 
        references ss_role;

    alter table ss_user_role 
        add constraint FK1306854B74AAF490 
        foreign key (user_id) 
        references ss_user;
