...
api: {
    read : 'record/technician!searchTechBadgeInfo.action',
    create : 'record/technician!saveTechnicianBadge.action',
    update : 'record/technician!saveTechnicianBadge.action',
    destroy: 'record/technician!delete.action'
	}
});
...
com.cce.cert.OrgTechnician=Ext.extend(Ext.Panel,{
	id:'OrgTechnician',
	loadMask: true,
	border: false,
	enableHdMenu: false,
...
com.cce.cert.OrgTechnicianMaster = Ext.extend(Ext.grid.GridPanel, {
	  id:'OrgTechnicianMaster',
	  stripeRows: true,
	  loadMask: true,
	  border: false,
	  enableHdMenu: false,
	  ...
	  initComponent : function() {
		    ...
		    // super
		    com.cce.cert.OrgTechnicianMaster.superclass.initComponent.call(this);
	        ...
	        if (!selected) {
		      ...
		      Ext.Msg.confirm('确认删除', '你确定删除该条记录?', function(btn) {
					if (btn == 'yes') {
				        ...
				        {
				        	Ext.getCmp('OrgTechnicianMaster').store.remove(rows[i]);
				        }
				        Ext.getCmp('OrgTechnicianMaster').store.save();
					}
		      });
	  }
});
...
com.cce.cert.TechnicianForm = Ext.extend(Ext.form.FormPanel, {
	title: '执法人员分级管理',
	modal:true,
	iconCls: 'silk-user',
	labelWidth: 100,
  ...
  // private A pointer to the currently loaded record
	...
	initComponent : function() {
	    ...
	    // super
	    com.cce.cert.TechnicianForm.superclass.initComponent.call(this);
	},
    scope:this,	
	...
	{
		var thestore=Ext.getCmp('OrgTechnicianMaster').store;
...
var searchEnforceOfficerInfo = function() {
	...
	Ext.getCmp('OrgTechnicianMaster').store.load({
		params : { 
...
com.cce.cert.TechnicianSearchForm = Ext.extend(Ext.form.FormPanel, {
	title: '档案分级查询',
	modal:true,
	iconCls: 'silk-user',
	labelWidth: 100,
	...
	initComponent : function() {
	    ...
	    // super
	    com.cce.cert.TechnicianSearchForm.superclass.initComponent.call(this);
	},
...
Ext.extend(com.cce.Module, {
	...
	init: function(){
		...
		this.master = new com.cce.cert.OrgTechnicianMaster({ store : this.store });
//		this.detail= new com.cce.cert.OrgTechnicianDetail({ store : this.store });
		this.frame= new com.cce.cert.OrgTechnician();		
...
//		this.frame.add(this.detail);
	...
	showSearchForm : function(g, store, record){
		...
		var form = new com.cce.cert.TechnicianSearchForm();
	...
	showForm : function(g, store, record){
		...
		var form = new com.cce.cert.TechnicianForm();
		this.newWin = new Ext.Window({
		    title: '专业技术人员管理',
		    closable:true,
		    width:600,
