...
var proxy = new Ext.data.HttpProxy({
	api: {
		    read : 'companyinno/AppButch!list.action',
		    create : 'companyinno/AppButch!save.action',
		    destroy: 'companyinno/AppButch!delete.action'
		}
});
...
//主panel 
com.cce.companyinno.OrgCompanyinnoButch=Ext.extend(Ext.Panel,{
	id:'OrgCompanyinno-Butch-main',
	loadMask: true,
	border: false,
	enableHdMenu: false,
	header:false,
...
com.cce.companyinno.OrgCompanyinnoButchMaster = Ext.extend(Ext.grid.GridPanel, {
	  id:'OrgCompanyinnoButchMaster',
	  stripeRows: true,
	  loadMask: true,
	  border: false,
	  enableHdMenu: false,
	  ...
	  initComponent : function() {
		    ...
		    // super
		    com.cce.companyinno.OrgCompanyinnoButchMaster.superclass.initComponent.call(this);
...
//					});
      ...
      onNetPass:function(){
	        ...
	        Ext.Ajax.request({ 
				url : 'companyinno/AppButch!netPass.action',
				scope: this,
				params : { 
	  ...
	  onSceenPass:function(){
	        ...
	        Ext.Ajax.request({ 
				url : 'companyinno/AppButch!sceenPass.action',
				scope: this,
				params : { 
				 data:Ext.encode(rowids)
				}, 
...
//------------------------------------------------------------------------------
//Module的OrgCompanyinnoButchDetail内容Panel定义..
//------------------------------------------------------------------------------

com.cce.companyinno.OrgCompanyinnoButchDetail=Ext.extend(Ext.grid.GridPanel ,{
	  id:'OrgCompanyinnoButchDetail',
	  title:'审批历史',
	  stripeRows: true,
	  loadMask: true,
	  border: false,
	  ...
	  initComponent : function() {
		    ...
		    // super
		    com.cce.companyinno.OrgCompanyinnoButchDetail.superclass.initComponent.call(this);
...
com.cce.companyinno.OrgCompanyinnoButchForm=Ext.extend(Ext.form.FormPanel, {
	title: '待宰前死亡',
	modal:true,
	iconCls: 'silk-user',
	labelWidth: 100,
	...
	initComponent : function() {
	    ...
	    // super
	    com.cce.companyinno.OrgCompanyinnoButchForm.superclass.initComponent.call(this);
...
com.cce.companyinno.OrgCompanyinnoButchTaskNetBackForm = Ext.extend(Ext.form.FormPanel, {
	...
	initComponent : function() {	 
	    ...
	    // super
	    com.cce.companyinno.OrgCompanyinnoButchTaskNetBackForm.superclass.initComponent.call(this);
    ...
    update : function(btn, ev) {
	      ...
	      var selected = Ext.getCmp('OrgCompanyinnoButchMaster').getSelectionModel().getSelected();
	      if (!selected) {
	            return false;
	      }
	      var rows=Ext.getCmp('OrgCompanyinnoButchMaster').getSelectionModel().getSelections();
	      var rowids = [];
	      for(var i=0;i<rows.length;i++)
	      {
	        	rowids.push(rows[i].get("id"));
...
//	      };
	      Ext.Ajax.request({ 
				url : 'companyinno/AppButch!netBack.action',
				scope: this,
//				params : { 
...
//				}, 
				...
				success : function(response) { 
				   ...
				   org_butch_store.load({
					   scope: this,
					   params:{start:0,limit:20},
					   callback:function(records,options,succees){
						   var record = Ext.getCmp('OrgCompanyinnoButchMaster').getSelectionModel().getSelected();
...
com.cce.companyinno.OrgCompanyinnoButchTaskSceenBackForm = Ext.extend(Ext.form.FormPanel, {
	...
	initComponent : function() {	 
	    ...
	    // super
	    com.cce.companyinno.OrgCompanyinnoButchTaskSceenBackForm.superclass.initComponent.call(this);
...
//	      };
	      Ext.Ajax.request({ 
				url : 'companyinno/AppButch!sceenBack.action',
				scope: this,
//				params : { 
//				 data:Ext.encode(data)
//				}, 
...
var org_butch_store = new Ext.data.Store({
...
com.cce.companyinno.OrgCompanyinnoButchContentPanel=Ext.extend(Ext.Panel ,{
   id:'OrgCompanyinnoButchContentPanel',
   region:'south',
   height:260,
   title:'详细信息',
   split:true,
   ...
   bodyStyle: 'padding: 10px; font-family: Arial; font-size: 12px;',
	initComponent: function(store){
		this.stroe = store;
		com.cce.companyinno.OrgCompanyinnoButchContentPanel.superclass.initComponent.call(this);
	}
});
...
Ext.extend(com.cce.Module, {
	...
	init: function(){
		...
		this.master = new com.cce.companyinno.OrgCompanyinnoButchMaster({ store : org_butch_store });
		this.detail= new com.cce.companyinno.OrgCompanyinnoButchDetail({ store : org_store_detail });
		this.full = new com.cce.companyinno.OrgCompanyinnoButchContentPanel();
		this.frame= new com.cce.companyinno.OrgCompanyinnoButch();		
		...
		this.master.on('rowclick', function(g, index, ev){
		    ...
		    '</tr>'+
			'</table>';
			Ext.getCmp('OrgCompanyinnoButchContentPanel').body.update(html);
		}, this);
		...
		org_butch_store.load({params:{start:0,limit:20}}); 
	...
	showViewForm : function(g, store, record){
		...
		var form = new com.cce.companyinno.OrgCompanyinnoButchForm();
	...
	showNetBackForm:function(g, store, record){
		...
		var form = new com.cce.companyinno.OrgCompanyinnoButchTaskNetBackForm();
	...
	showSceenBackForm:function(g, store, record){
		...
		var form = new com.cce.companyinno.OrgCompanyinnoButchTaskSceenBackForm();
