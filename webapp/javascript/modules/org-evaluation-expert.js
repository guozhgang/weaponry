...
api: {
    read : 'info/evalExpert!list.action',
    create : 'info/evalExpert!save.action',
    update: 'info/evalExpert!save.action',
    destroy: 'info/evalExpert!delete.action'
}
});
...
com.cce.members.OrgEvalExpert=Ext.extend(Ext.Panel,{
	id:'OrgEvalExpert',
	loadMask: true,
	border: false,
	enableHdMenu: false,
...
com.cce.members.EvalExpertForm = Ext.extend(Ext.form.FormPanel, {
	title: '管理机构基本信息',
	modal:true,
	iconCls: 'silk-user',
	header: false,
    ...
    initComponent : function() {
	    ...
	    // super
	    com.cce.members.EvalExpertForm.superclass.initComponent.call(this);
	},
...
com.cce.members.OrgEvalExpertMaster = Ext.extend(Ext.grid.GridPanel, {
	  id:'com.cce.members.OrgEvalExpertMaster',
	  stripeRows: true,
	  loadMask: true,
	  border: false,
	  enableHdMenu: false,
	  ...
	  initComponent : function() {
		    ...
		    // super
		    com.cce.members.OrgEvalExpertMaster.superclass.initComponent.call(this);
	        ...
	        if (!selected) {
		      ...
		      Ext.Msg.confirm('确认删除', '你确定删除该条记录?', function(btn) {
					if (btn == 'yes') {
				        ...
				        {
				        	Ext.getCmp('com.cce.members.OrgEvalExpertMaster').store.remove(rows[i]);
				        }
				        Ext.getCmp('com.cce.members.OrgEvalExpertMaster').store.save();
					}
		      });
	  }
});
...
//com.cce.members.OrgEvalExpertDetail=Ext.extend(Ext.Panel ,{
//	 id:'OrgEvalExpertDetail',
//	 region:'south',
//	 height:260,
//	 title:'详细信息',
//	 split:true,
...
//
//		this.stroe = store;
//		com.cce.members.OrgEvalExpertDetail.superclass.initComponent.call(this);
//		
//		 
//	}	  
//	
...
Ext.extend(com.cce.Module, {
	...
	init: function(){
		...
		this.master = new com.cce.members.OrgEvalExpertMaster({ store : this.store });
//		this.detail= new com.cce.members.OrgEvalExpertDetail({ store : this.store });
		this.frame= new com.cce.members.OrgEvalExpert();		
...
//		this.frame.add(this.detail);
	...
	showForm : function(g, store, record){
		...
		var form = new com.cce.members.EvalExpertForm();
