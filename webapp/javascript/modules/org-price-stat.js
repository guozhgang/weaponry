...
var proxy = new Ext.data.HttpProxy({
	api: {
	    	read : 'trace/trace!priceStat.action'
...
var reader = new Ext.data.JsonReader(
		...
		[ 
		     //企业备案统计的
		     {name: 'trace_city',mapping:'city'}, //所属区
//		  	{name: 'trace_count',mapping:'count'},//总重量
//			{name: 'trace_num',mapping:'num'}, //生产批数
			{name: 'trace_price',mapping:'price'}  //均价
...
var columns = [
	...
	{header:'区域/企业',dataIndex:'trace_city'},
//	{header:'总重量',dataIndex:'trace_count'},
//	{header:'生产批数',dataIndex:'trace_num'},
	{header:'均价',dataIndex:'trace_price'} 
...
com.cce.price.OrgTracePriceStat=Ext.extend(Ext.Panel,{
		  id:'OrgTracePriceStat',
		  stripeRows: true,
		  loadMask: true,
		  border: false,
		  enableHdMenu: false,
		  ...
		  initComponent : function() {
			    ...
			    // super
			    com.cce.price.OrgTracePriceStat.superclass.initComponent.call(this);
...
com.cce.price.OrgTracePriceStatGrid = Ext.extend(Ext.grid.GridPanel, {
	 // title:'执法人员表格',
	  stripeRows: true,
	  loadMask: true,
	  border: false,
...
//		    this.bbar = this.buildBottomToolbar();	    
		    ...
		    com.cce.price.OrgTracePriceStatGrid.superclass.initComponent.call(this);
...
com.cce.price.OrgTracePriceStatForm = Ext.extend(Ext.form.FormPanel, {
	title: '溯源统计',
	modal:true,
	iconCls: 'silk-user',
	labelWidth: 100,
	...
	initComponent : function() {
		...
		this.regionTree = new Ext.tree.TreePanel({
			...
			hiddenRegionId : new Ext.form.Hidden({ name:"regionIdd" }),
			id : 'cce_regionTree',
			title : '所属地区: ',
			anchor : '100%',
			colspan:2,
	    ...
	    // super
	    com.cce.price.OrgTracePriceStatForm.superclass.initComponent.call(this);
...
Ext.extend(com.cce.Module, {
	...
	init: function(){
		...
		this.frame= new com.cce.price.OrgTracePriceStat();	
	    ...
	    var Officer_panel = new   com.cce.price.OrgTracePriceStatGrid({ store : this.store});
	...
	showStatForm : function(g){
		...
		var form = new com.cce.price.OrgTracePriceStatForm();
