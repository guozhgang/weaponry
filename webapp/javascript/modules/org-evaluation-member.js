...
api: {
    read : 'info/evalMember!list.action',
    create : 'info/evalMember!save.action',
    update: 'info/evalMember!save.action',
    destroy: 'info/evalMember!delete.action'
}
});
...
com.cce.members.OrgEvalMember=Ext.extend(Ext.Panel,{
	id:'OrgEvalMember',
	loadMask: true,
	border: false,
	enableHdMenu: false,
...
com.cce.members.EvalMemberForm = Ext.extend(Ext.form.FormPanel, {
	title: '管理机构基本信息',
	modal:true,
	iconCls: 'silk-user',
	header: false,
    ...
    initComponent : function() {
	    ...
	    // super
	    com.cce.members.EvalMemberForm.superclass.initComponent.call(this);
	},
...
com.cce.members.OrgEvalMemberMaster = Ext.extend(Ext.grid.GridPanel, {
	  id:'com.cce.members.OrgEvalMemberMaster',
	  stripeRows: true,
	  loadMask: true,
	  border: false,
	  enableHdMenu: false,
	  ...
	  initComponent : function() {
		    ...
		    // super
		    com.cce.members.OrgEvalMemberMaster.superclass.initComponent.call(this);
	        ...
	        if (!selected) {
		      ...
		      Ext.Msg.confirm('确认删除', '你确定删除该条记录?', function(btn) {
					if (btn == 'yes') {
				        ...
				        {
				        	Ext.getCmp('com.cce.members.OrgEvalMemberMaster').store.remove(rows[i]);
				        }
				        Ext.getCmp('com.cce.members.OrgEvalMemberMaster').store.save();
					}
		      });
	  }
});
...
//com.cce.members.OrgEvalMemberDetail=Ext.extend(Ext.Panel ,{
//	 id:'OrgEvalMemberDetail',
//	 region:'south',
//	 height:260,
//	 title:'详细信息',
//	 split:true,
...
//
//		this.stroe = store;
//		com.cce.members.OrgEvalMemberDetail.superclass.initComponent.call(this);
//		
//		 
//	}	  
//	
...
Ext.extend(com.cce.Module, {
	...
	init: function(){
		...
		this.master = new com.cce.members.OrgEvalMemberMaster({ store : this.store });
//		this.detail= new com.cce.members.OrgEvalMemberDetail({ store : this.store });
		this.frame= new com.cce.members.OrgEvalMember();		
...
//		this.frame.add(this.detail);
	...
	showForm : function(g, store, record){
		...
		var form = new com.cce.members.EvalMemberForm();
